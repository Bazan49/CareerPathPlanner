...
def setup_logger(name: str = "CareerPathPlanner", log_file: str = None,
    ...
    Si console_output es False, no se muestra en consola.
    """
...
# Logger por defecto: solo archivo, sin consola
ROOT_DIR = Path(__file__).resolve().parent.parent.parent
DEFAULT_LOG_FILE = ROOT_DIR.joinpath("app.log")

default_logger = setup_logger(log_file=str(DEFAULT_LOG_FILE), console_output=False)